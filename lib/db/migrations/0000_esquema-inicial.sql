CREATE TYPE "public"."caregiver_relationship" AS ENUM('filho_filha', 'conjuge', 'neto_neta', 'irmao_irma', 'contratado', 'amigo', 'outro');--> statement-breakpoint
...
CREATE TYPE "public"."schedule_type" AS ENUM('times_per_day', 'every_n_hours', 'specific_weekdays', 'alternate_days', 'cycle_with_pause', 'se_necessario');--> statement-breakpoint
...
CREATE TYPE "public"."scheduled_dose_status" AS ENUM('pending', 'taken', 'skipped', 'late', 'postponed', 'partial');--> statement-breakpoint
CREATE TYPE "public"."dose_outcome" AS ENUM('taken', 'skipped', 'postponed', 'partial');--> statement-breakpoint
...
CREATE TYPE "public"."notification_type" AS ENUM('dose_reminder', 'dose_late', 'appointment_reminder', 'low_stock', 'system', 'treatment_ending', 'continuous_review', 'moment_new');--> statement-breakpoint
...
CREATE TYPE "public"."consent_type" AS ENUM('terms_of_service', 'privacy_policy', 'health_data_processing', 'marketing', 'data_sharing', 'image_capture');--> statement-breakpoint
...
CREATE TYPE "public"."notification_category" AS ENUM('dose', 'appointment', 'stock', 'treatment', 'moment');--> statement-breakpoint
...
CREATE TABLE "patients" (
	...
	"uncovered_since" timestamp with time zone DEFAULT now() NOT NULL,
	"uncovered_alert_sent_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "caregiver_patients" (
	...
	"created_by_caregiver_id" integer,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "caregiver_patients_par_unico" UNIQUE("caregiver_id","patient_id")
);
--> statement-breakpoint
...
CREATE TABLE "dose_records" (
	...
	"corrected_by_caregiver_id" integer,
...
CREATE TABLE "users" (
	...
	"recovery_email" text,
	"recovery_email_at" timestamp with time zone,
	"resgate_liberado_ate" timestamp with time zone,
	"segundo_fator_ativo_em" timestamp with time zone,
...
CREATE TABLE "trusted_devices" (
	...
	"revoked_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "uq_trusted_devices_token" UNIQUE("token_hash")
);
--> statement-breakpoint
CREATE TABLE "device_verifications" (
	"id" serial PRIMARY KEY NOT NULL,
	"user_id" integer NOT NULL,
	"desafio_hash" text NOT NULL,
	"codigo_hash" text NOT NULL,
	"attempts" integer DEFAULT 0 NOT NULL,
	"expires_at" timestamp with time zone NOT NULL,
	"used" boolean DEFAULT false NOT NULL,
	...
	"user_agent" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "uq_device_verifications_desafio" UNIQUE("desafio_hash")
);
--> statement-breakpoint
...
CREATE TABLE "media_assets" (
	...
	"family_id" integer NOT NULL,
	"patient_id" integer NOT NULL,
	"uploaded_by_caregiver_id" integer,
...
CREATE TABLE "media_reactions" (
	...
	"caregiver_id" integer NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "uq_media_reaction_asset_caregiver" UNIQUE("media_asset_id","caregiver_id")
);
--> statement-breakpoint
...
ALTER TABLE "caregiver_patients" ADD CONSTRAINT "caregiver_patients_caregiver_id_caregivers_id_fk" FOREIGN KEY ("caregiver_id") REFERENCES "public"."caregivers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "caregiver_patients" ADD CONSTRAINT "caregiver_patients_patient_id_patients_id_fk" FOREIGN KEY ("patient_id") REFERENCES "public"."patients"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "caregiver_patients" ADD CONSTRAINT "caregiver_patients_created_by_caregiver_id_caregivers_id_fk" FOREIGN KEY ("created_by_caregiver_id") REFERENCES "public"."caregivers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "dose_records" ADD CONSTRAINT "dose_records_corrected_by_caregiver_id_caregivers_id_fk" FOREIGN KEY ("corrected_by_caregiver_id") REFERENCES "public"."caregivers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "shifts" ADD CONSTRAINT "shifts_caregiver_id_caregivers_id_fk" FOREIGN KEY ("caregiver_id") REFERENCES "public"."caregivers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "shifts" ADD CONSTRAINT "shifts_created_by_caregiver_id_caregivers_id_fk" FOREIGN KEY ("created_by_caregiver_id") REFERENCES "public"."caregivers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "recovery_emails" ADD CONSTRAINT "recovery_emails_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "trusted_devices" ADD CONSTRAINT "trusted_devices_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "device_verifications" ADD CONSTRAINT "device_verifications_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "media_assets" ADD CONSTRAINT "media_assets_family_id_families_id_fk" FOREIGN KEY ("family_id") REFERENCES "public"."families"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "media_assets" ADD CONSTRAINT "media_assets_patient_id_patients_id_fk" FOREIGN KEY ("patient_id") REFERENCES "public"."patients"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "media_assets" ADD CONSTRAINT "media_assets_uploaded_by_caregiver_id_caregivers_id_fk" FOREIGN KEY ("uploaded_by_caregiver_id") REFERENCES "public"."caregivers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "media_reactions" ADD CONSTRAINT "media_reactions_media_asset_id_media_assets_id_fk" FOREIGN KEY ("media_asset_id") REFERENCES "public"."media_assets"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "media_reactions" ADD CONSTRAINT "media_reactions_caregiver_id_caregivers_id_fk" FOREIGN KEY ("caregiver_id") REFERENCES "public"."caregivers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "idx_shifts_patient" ON "shifts" USING btree ("patient_id");--> statement-breakpoint
CREATE INDEX "idx_notifications_delivery_stats" ON "notifications" USING btree ("family_id","type","sent_at");--> statement-breakpoint
CREATE INDEX "idx_notifications_admin_metrics" ON "notifications" USING btree ("type","sent_at");--> statement-breakpoint
CREATE INDEX "idx_email_verifications_ativo" ON "email_verifications" USING btree ("user_id","used","expires_at");--> statement-breakpoint
CREATE INDEX "idx_email_changes_pendente" ON "email_changes" USING btree ("user_id","used","expires_at");--> statement-breakpoint
CREATE INDEX "idx_password_resets_ativo" ON "password_resets" USING btree ("user_id","used","expires_at");--> statement-breakpoint
CREATE INDEX "idx_recovery_emails_pendente" ON "recovery_emails" USING btree ("user_id","used","expires_at");--> statement-breakpoint
CREATE INDEX "idx_trusted_devices_usuario" ON "trusted_devices" USING btree ("user_id","revoked","expires_at");--> statement-breakpoint
CREATE INDEX "idx_device_verifications_pendente" ON "device_verifications" USING btree ("user_id","used","expires_at");--> statement-breakpoint
CREATE INDEX "idx_recovery_codes_usuario" ON "recovery_codes" USING btree ("user_id","code_hash");--> statement-breakpoint
CREATE INDEX "idx_media_assets_patient_timeline" ON "media_assets" USING btree ("patient_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_media_reactions_asset" ON "media_reactions" USING btree ("media_asset_id");